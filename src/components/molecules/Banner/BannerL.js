  ...
  return (
    <>
      <RstFlex mb={24} height="770px" width="100%" backgroundColor="black">
        <RstFlex flex={1} justifyContent="center" backgroundColor="#5EACA9">
          <TextFrame />
        </RstFlex>

        <RstFlex flex={1} justifyContent="center" backgroundColor="#8AC1E1">
          <TextFrame />
        </RstFlex>
        <RstFlex flex={1} justifyContent="center" backgroundColor="#B199AA">
          <TextFrame />
        </RstFlex>
      </RstFlex>
    </>
